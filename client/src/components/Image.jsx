        ...
        <div className="shadow-insideChatBox my-4 rounded-lg py-4 px-2">
          ...
          <div className="w-full h-full flex justify-evenly">
            <div
              ...
              onMouseLeave={(e) => {setimg1Hover(false); setselectedImg(null)}}
            >
              <img
                className="w-[360px] h-[310px] rounded-md"
                src={images[0]}
                alt=""
                onMouseEnter={(e) => {setimg1Hover(true); setselectedImg(e.target.src)}}
              ...
              {img1Hover ? (
                <button
                  ...
                  onClick={() => addBookmark(selectedImg)}
                >
            ...
            <div className="w-[390px] h-[320px] flex flex-wrap justify-evenly">
              <div
                ...
                onMouseLeave={() => {setimg2Hover(false); setselectedImg(null)}}
              >
                <img
                  className="w-[180px] h-[150px] rounded-md"
                  src={images[1]}
                  alt=""
                  onMouseEnter={(e) => {setimg2Hover(true); setselectedImg(e.target.src)}}
                  onError={(e)=>e.target.src=images[getRandomInt(9)]}
                />
                {img2Hover ? (
                  <button
              ...
              <div
                ...
                onMouseLeave={() => {setimg3Hover(false); setselectedImg(null)}}
              >
                <img
                  className="w-[180px] h-[150px] rounded-md"
                  src={images[2]}
                  alt=""
                  onMouseEnter={(e) => {setimg3Hover(true); setselectedImg(e.target.src)}}
                  onError={(e)=>e.target.src=images[getRandomInt(9)]}
                />
                {img3Hover ? (
                  <button
              ...
              <div
                ...
                onMouseLeave={() => {setimg4Hover(false); setselectedImg(null)}}
              >
                <img
                  className="w-[180px] h-[150px] rounded-md"
                  src={images[3]}
                  alt=""
                  onMouseEnter={(e) => {setimg4Hover(true); setselectedImg(e.target.src)}}
                  onError={(e)=>e.target.src=images[getRandomInt(9)]}
                />
                {img4Hover ? (
                  <button
              ...
              <div
                className="w-[180px] h-[150px]"
                onMouseLeave={() => {setimg5Hover(false); setselectedImg(null)}}
              >
                <img
                  className="w-[180px] h-[150px] rounded-md"
                  src={images[4]}
                  alt=""
                  onMouseEnter={(e) => {setimg5Hover(true); setselectedImg(e.target.src)}}
                  onError={(e)=>e.target.src=images[getRandomInt(9)]}
                />
                {img5Hover ? (
                  <button
